...
export default async function OpsIntakeDetailPage(props: { params: ParamsPromise }) {
  ...
  return (
    <section className="section" style={{ paddingTop: 0 }}>
      ...
      <div style={{ marginTop: 14, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 12 }}>
        ...
        <div className="card">
          <div className="cardInner">
            ...
            <div className="pDark">
              <strong>Industry:</strong> {intake.industry || "—"}<br />
              <strong>Team size:</strong> {intake.team_size || "—"}<br />
              <strong>Job volume:</strong> {intake.job_volume || "—"}<br />
              <strong>Urgency:</strong> {intake.urgency || "—"}<br />
              <strong>Readiness:</strong> {intake.readiness || "—"}<br />
        ...
        <div className="card">
          <div className="cardInner">
            ...
            {latestCall ? (
              <div className="pDark">
                <strong>Status:</strong> <span className="badge">{latestCall.status || "submitted"}</span><br />
                <strong>Created:</strong> {fmtDate(latestCall.created_at)}<br />
                <strong>Best time:</strong> {latestCall.best_time_to_call || "—"}<br />
                <strong>Preferred window:</strong> {latestCall.preferred_times || "—"}<br />
                <strong>Timezone:</strong> {latestCall.timezone || "—"}<br />
      ...
      <div className="card">
        <div className="cardInner">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10, marginBottom: 16 }}>
            <h2 className="h2">PIE Analysis</h2>
      ...
      <div className="card">
        <div className="cardInner">
          <h2 className="h2">Raw Intake Data</h2>
          <details>
