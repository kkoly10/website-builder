...
function BuildFormInner() {
  ...
  return (
    <div>
      ...
      <h1 className="h1">Scope your project</h1>
      <p className="p">
        {stepLabel}
      </p>
      ...
      {step === 0 && (
        <section className="grid2">
          <div className="panel cardHover" onClick={() => goMode("guided")}>
            <div className="panelHeader">
              <h2 className="h2">Help me decide</h2>
              <p className="pDark">We’ll ask goal-based questions and recommend the best setup.</p>
            </div>
            <div className="panelBody">
              <button className="btn btnPrimary">Start guided intake <span className="btnArrow">→</span></button>
            </div>
          </div>
          <div className="panel cardHover" onClick={() => goMode("known")}>
            <div className="panelHeader">
              <h2 className="h2">I know what I need</h2>
              <p className="pDark">You already know your requirements. We’ll jump straight to scope.</p>
            </div>
            <div className="panelBody">
              <button className="btn btnGhost">Start scope intake <span className="btnArrow">→</span></button>
            </div>
          </div>
        </section>
      )}
      ...
      {step === 1 && (
        <section className="panel">
          <div className="panelHeader">
            <h2 className="h2">{form.mode === "guided" ? "What is the primary goal?" : "What type of website?"}</h2>
          </div>
          <div className="panelBody">
            {form.mode === "guided" ? (
              <>
      ...
      {step === 2 && (
        <section className="panel">
          ...
          <div className="panelBody">
            {form.mode === "guided" && (
              <div className="hint">
                <div className="fieldLabel">Suggested Setup:</div>
                <ul >
      ...
      {step === 3 && (
        <section className="panel">
          <div className="panelHeader">
            <h2 className="h2">Features & Integrations</h2>
          </div>
          <div className="panelBody" >
      ...
      {step === 5 && (
        <section className="panel">
          <div className="panelHeader">
            <h2 className="h2">Timeline & Details</h2>
          </div>
          <div className="panelBody" >
            <div className="grid2">
              <div>
      ...
      {step === 6 && (
        <section className="panel">
          <div className="panelHeader">
            <h2 className="h2">Review Scope</h2>
          </div>
          <div className="panelBody">
            <ul className="serviceCardList" >
              <li>Website Type: <strong>{form.websiteType}</strong></li>
              <li>Total Pages: <strong>{form.pages}</strong></li>
              <li>Content Readiness: <strong>{form.contentReady}</strong></li>
              <li>Timeline: <strong>{form.timeline}</strong></li>
              <li>Features: <strong>{[form.booking && "Booking", form.payments && "Payments", form.membership && "Membership"].filter(Boolean).join(", ") || "None"}</strong></li>
            </ul>
          </div>
        </section>
      )}
      ...
      {step === 7 && (
        <section className="panel ctaCard">
          <div className="panelHeader">
            <h2 className="h2">Where should we send the estimate?</h2>
          </div>
          <div className="panelBody" >
            <div>
