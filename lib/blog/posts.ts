  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        type: "p",
        text:
          "Four of our own SaaS products run AI, at different autonomy levels — which is how we know the distinction matters in practice. Fleiko has an AI copilot that flags vehicle issues (Level 2 — suggests, fleet manager confirms). Proveo has a confidence-gated agent that processes contractor photo submissions (Level 3 — high-confidence auto-approves, low-confidence routes to human review). Korent uses AI for operator support across inventory and bookings (Level 2 — suggests, operator confirms). Kocre IT auto-resolves IT tickets via a six-gate engine (Level 3 with strict gating). Two of those are copilots and two are confidence-gated agents — each shaped by the cost-of-wrong for its specific action, not by which level sounded better in a pitch.",
      },
