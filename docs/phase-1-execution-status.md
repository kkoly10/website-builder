...
| **Homepage — trust copy pass** | [#100](https://github.com/kkoly10/website-builder/pull/100) | 🟡 Open (building) | Honest copy audit: "senior practitioner" → "practitioner" (hero sub + `/custom-web-apps` meta); proof strip "Senior" → "Practitioner"; "No surprises" → "No guesswork"; "Accepting 3–4 projects per quarter" → "Taking on new projects"; Korent tagline "Operating system" → "Management platform"; Korent chip "AI copilot" → "AI scheduling". Applied to en/fr/es. |
