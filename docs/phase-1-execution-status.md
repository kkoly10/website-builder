...
| **6 — `/pricing` rebuild** | — | ⏳ **Not started** | Rebuild `/pricing` as a single anchor-navigated scrollable page across all five lanes + Care plans. Use locked pricing from the opportunity doc § Service Package Architecture. Last Phase 1 task. |
...
The next task as of this doc's last update is **Task 6 — `/pricing` rebuild**. After Task 6 ships, Phase 1 is complete and the next milestone is Phase 2.
