      ...
      <div className="card">
        <div className="cardInner">
          <div className="kicker">
            <span className="kickerDot" /> E-Commerce Lead Summary
          </div>
          ...
          <div className="pills" style={{ marginTop: 10 }}>
            <span className="pill">Intake: {formatStatus(intake.status, "new")}</span>
            <span className="pill">Call: {formatStatus(call?.status, "not requested")}</span>
            <span className="pill">Quote: {formatStatus(quote?.status, "not started")}</span>
      ...
      <div className="grid2" style={{ marginTop: 12 }}>
        ...
        <div className="card">
          <div className="cardInner" style={{ display: "grid", gap: 8 }}>
            ...
            <div className="pDark"><strong>Status:</strong> {formatStatus(call?.status, "not requested")}</div>
            ...
            <div style={{ marginTop: 10, display: "flex", gap: 8, flexWrap: "wrap" }}>
              <Link href={`/ecommerce/book?ecomIntakeId=${encodeURIComponent(intakeId)}`} className="btn btnGhost">
                Book / Update Call
              </Link>
