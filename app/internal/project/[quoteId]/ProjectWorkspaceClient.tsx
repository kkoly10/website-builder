  ...
  return (
    <div className="row" style={{ flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "flex-start", flexWrap: "wrap" }}>
            <div style={{ minWidth: 260 }}>
              ...
              <div className="row" style={{ gap: 8, marginTop: 10 }}>
                <span className="badge" >Admin: {project?.project_status || project?.status || "—"}</span>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-end" }}>
              ...
              <Link href={`/internal/admin/${quoteId}`} className="btn btnGhost">
      ...
      <div className="grid2" style={{ alignItems: "start" }}>
        ...
        <div className="card">
          <div className="cardInner">
            <h2 className="h2">Scope Snapshots</h2>
        ...
        <div className="card">
          <div className="cardInner">
            ...
            <div className="panel">
              <div className="panelHeader"><div>Create New Change Order</div></div>
              <div className="panelBody">
                <div>
              ...
              <div className="row" style={{ flexDirection: "column", gap: 10 }}>
                {changeOrders.map((co) => (
                  <div key={co.id} className="panel">
                    ...
                    <div className="panelBody">
                      <div className="pDark">{co.reason}</div>
