...
export default async function RootLayout({
  ...
  // SEO note: the Organization / WebSite / Person @graph used to live here
  // as an inline <script>. It moved into app/[locale]/layout.tsx so that
  // it can reference @id'd nodes that per-page Service / Article schemas
  // link back to (see lib/seo/structuredData.ts). Non-locale routes like
  // /portal and /internal are auth-gated and robots-disallowed, so they
