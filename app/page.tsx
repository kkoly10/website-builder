...
export default function Home() {
  return (
    <main className="homePage">
      ...
      {/* 3. THE TWO CLEAR PATHS (SOLUTIONS) */}
              ...
              <div className="cardInner" style={{ padding: 40, height: "100%", display: "flex", flexDirection: "column" }}>
                <div>
                  ...
                  <p className="p" style={{ marginTop: 12 }}>
                    Stop manually typing client data. I connect your forms, CRM, and accounting software (QuickBooks, Stripe) so data flows automatically.
                  </p>
